...
class PlanningGraph():
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        a1_effect_add_set = set(node_a1.action.effect_add)
        a1_effect_rem_set = set(node_a1.action.effect_rem)

        a2_effect_add_set = set(node_a2.action.effect_add)
        a2_effect_rem_set = set(node_a2.action.effect_rem)

        inconsistent_check_1 = list(a1_effect_add_set & a2_effect_rem_set)
        inconsistent_check_2 = list(a1_effect_rem_set & a2_effect_add_set)

        if len(inconsistent_check_1) > 0 or len(inconsistent_check_2) > 0:
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        interference_test_1 = list(a1_effect_add_set & a2_precond_neg)
        interference_test_2 = list(a1_effect_rem_set & a2_precond_pos)
        interference_test_3 = list(a2_effect_add_set & a1_precond_neg)
        interference_test_4 = list(a2_effect_rem_set & a1_precond_pos)
        # TODO test for Interference between nodes

        if len(interference_test_1) > 0 or len(interference_test_2) > 0 or len(interference_test_3) > 0  or len(interference_test_4) > 0:
           return True
        else:
            return False
    ...
    def negation_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s) -> bool:
        ...
        literal_1 = (node_s1.symbol == node_s2.symbol)
        literal_2 = (node_s1.is_pos != node_s2.is_pos)


        return (literal_1 and literal_2)
